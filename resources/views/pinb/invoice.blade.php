...
<section class="panel">
    <div class="panel-body">
        <form class="form-horizontal" role="form" method="POST" action="{{ route('pinb.order') }}">
            <div class="form-group">
                <div class="col-sm-10 col-sm-offset-1 col-lg-10 col-lg-offset-1">
                    ...
                    <div class="well">
                        <div class="row">
                            <div class="col-md-2">
                                <h5><a href="{{ route('pinb.confirm.image') }}?img={{ $confirm_order->filename }}" target="_blank" class="btn btn-xs btn-default"><img src="{{ route('pin.confirm.image') }}?img={{ $confirm_order->filename }}" class="img-responsive"></a></h4>
                            </div>
                            <div class="col-md-4">
