...
Here your personal identity (Resend):
...
<table cellpadding="0" cellspacing="0" style="color:#000;font-family:Ubuntu,Helvetica,Arial,sans-serif;font-size:13px;line-height:22px;table-layout:auto" width="100%" border="0">
        ...
        <tr>
                <td style="border-bottom:1px dotted #ecedee;text-align:right;padding:15px 20px 0 0;background-color:#fafafa">Resend Activation Date </td>
