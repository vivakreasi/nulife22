...
@section('content')
    @if ($actions->continue)
        <section class="panel">
            <div class="panel-body">You have <b>{{$totalFreePin}}</b> PIN available to placement new member</div>
        </section>
        <form class="form-horizontal" method="post" id="form-placement" action="{{ route('plan.placement.post') }}">
