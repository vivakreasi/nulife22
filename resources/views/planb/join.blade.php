...
<section class="panel">
    <div class="panel-body">
        @if (isset($summaryPin) && $summaryPin->sisa > 0)
            <form class="form-horizontal tasi-form" role="form" method="POST" action="{{ route('planb.dojoin') }}">
                {{ csrf_field() }}
                <div class="form-group">
                    <div class="col-sm-10 col-sm-offset-1 col-lg-10 col-lg-offset-1">
                        <p>Joining NuLife Plan-B program is as simple as one click action. You can use your available PIN to joining the program.<br />If you have no PIN available, you can <code>purchase</code> PIN from <code><a href="{{ route('planc.trfinstruction') }}">Order PIN</a></code> menu.</p>
