...
@section('content')
<section class="panel">
        <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.edit.news.post') }}">
            <div class="panel-body">
                ...
                <div class="form-group{{ $errors->has('image_url') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-8">
                        <input id="image_url" type="text" class="form-control" name="image_url" value="{{ $data->image_url }}" required autofocus>
                ...
                <div class="form-group{{ $errors->has('sort_desc') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-8">
                        <textarea id="sort_desc" class="form-control" name="sort_desc" >{{ $data->sort_desc }}</textarea>
