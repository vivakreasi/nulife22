...
@section('vendor_style')
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/js/vendor/bootstrap-datepicker/css/datepicker.css') }}"/>
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/js/vendor/bootstrap-colorpicker/css/colorpicker.css') }}"/>
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/js/vendor/bootstrap-daterangepicker/daterangepicker-bs3.css') }}"/>
@endsection
            ...
            <div class="well well-lg">
                <div class="row">
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <a href="{{ route('admin.excel.planc.wd',['status' => $status]) }}" class="btn btn-success addon-btn" id="action-excel" target="_blank"><i class="fa fa-file-excel-o"></i>&nbsp;&nbsp;Export to Excel</a>
...
<script type="text/javascript" src="{{ asset('assets/js/vendor/bootstrap-datepicker/js/bootstrap-datepicker.js') }}"></script>
...
<script type="text/javascript">
    var myUrl = '<?php echo route("admin.ajax.planc.wd"); ?>';
    var nuTable;
    ...
    $(document).ready(function() {
        ...
        $('button#confirm').on('click', function() {
            ...
            if(konfirm){
                $.ajax({
                    type: "POST",
                    url: '{{ route("admin.confirm.planc.wd") }}',
                    data: {
                        id : $('#wdid').val(),
                        _token : $('#wtoken').val()
                    },
        ...
        $('button#reject').on('click', function() {
            ...
            if (note && note != '') {
                $.ajax({
                    type: "POST",
                    url: '{{ route("admin.reject.planc.wd") }}',
                    data: {
                        id : $('#wdid').val(),
                        note : note,
                        _token : $('#wtoken').val()
