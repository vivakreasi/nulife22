    ...
    <section class="panel">
        <div class="panel-body">
            <div class="control-table" style="margin-bottom: 5px;">
                <a href="{{ route('admin.excel.planc.claimc',['type' => $type , 'status' => $status]) }}" class="btn btn-success addon-btn" id="action-excel" target="_blank"><i class="fa fa-file-excel-o"></i>&nbsp;&nbsp;Export to Excel</a>
            </div>
...
@section('scripts')
    ...
    $(document).ready(function() {
        nuTable = $('#tbl-nulife').DataTable({
            ...
            autoWidth       : true,
            paginate        : true,
            ajax            : '{{ route("admin.ajax.planc.claimc") }}',
            columnDefs      : [
