...
<section class="panel">
    <div class="panel-body">
        <div class="control-table" style="margin-bottom: 5px;">
            <a href="{{ route('admin.pinb.report.xls') }}" class="btn btn-success addon-btn" id="action-excel" target="_blank"><i class="fa fa-file-excel-o"></i>&nbsp;&nbsp;Export Excel</a>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        nuTable = $('#tbl-nulife').DataTable({
            ...
            autoWidth       : true,
            paginate        : true,
            ajax            : '{{ route("admin.pinb.report.ajax") }}',
            columnDefs      : [
