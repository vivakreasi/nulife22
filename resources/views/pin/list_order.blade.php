...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        <form class="form-horizontal" role="form" method="POST" action="{{ route('pin.confirm') }}" enctype="multipart/form-data">
...
<script type="text/javascript">
    var myUrl = '<?php echo route("pin.ajax.list"); ?>';
    var nuTable;
        ...
        nuTable = $('#tbl-nulife').DataTable({
            ...
            */
            columns         : [
                ...
                {
                    render : function (data, type, full, meta) {
                        return '<a class="btn btn-sm btn-info" href="{{ route("pin.invoice", ["transaction_code" => null]) }}/'+full[2]+'">Detail</a>';
                    }
                }
            ],
        });
